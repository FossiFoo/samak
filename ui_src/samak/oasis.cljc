...
(def oasis1   [(defncall 'oasis-layout 'pipes/layout)
               ...
               (defncall 'raw-events 'pipes/station (api/string "raw-events"))
               (defncall 'reduced-events 'pipes/station (api/string "reduced-events"))
               (defncall 'events 'pipes/station (api/string "events"))
               ...
               (defncall 'input-reduce 'pipes/splitter
               ...
               (defncall 'keyboard-filtered 'pipes/station (api/string "keyboard-filtered"))
               ...
               (defncall 'make-view-move 'pipes/splitter
                 (api/fn-call (api/symbol '->)
                              [(api/key-fn :next)
               ...
               (defncall 'eval-events 'pipes/station (api/string "eval-events") ;; (api/keyword :oasis.spec/eval-state)
                 )

               ;; (defncall 'extract-eval '->
               ;;   (api/key-fn :samak.pipes/content))

               (defncall 'eval-reduce 'pipes/splitter
                 (api/fn-call (api/symbol '->)
               ...
               (defncall 'eval-raw 'pipes/station (api/string "eval-raw") ;; (api/keyword :oasis.spec/eval-state)
                 )
...
(def oasis2 [
              ...
              (defncall 'editor-events 'pipes/station (api/string "editor-events"))
              (defncall 'editor-cooked 'pipes/station (api/string "editor-cooked"))
              (defncall 'editor-immediate 'pipes/station (api/string "editor-immediate"))
              (defncall 'editor-actions 'pipes/station (api/string "editor-actions"))
              (defncall 'editor-state 'pipes/station (api/string "editor-state"))
              (defncall 'select-events 'pipes/station (api/string "select-events"))

              (defncall 'be-commands 'pipes/station (api/string "be-commands"))

               (defncall 'filter-call 'only (api/key-fn :call))

              (defncall 'mode-state 'pipes/station (api/string "mode-state"))
              (defncall 'mode-raw 'pipes/station (api/string "mode-raw"))
             ...
             (defncall 'process-scope '->
              ...
              (defncall 'editor-state-reduce 'pipes/splitter
                (api/fn-call (api/symbol '->)
                             [
             ...
             (defncall 'source-menu 'pipes/station (api/string "source-menu"))
             (defncall 'source-menu-items 'pipes/station (api/string "source-menu-items"))
             (defncall 'source-menu-events 'pipes/station (api/string "source-menu-events"))
             (defncall 'source-menu-state 'pipes/station (api/string "source-menu-state"))


             (defncall 'source-menu-const '->
               (api/vector [(api/string "station")
                            (api/string "ui")
                            (api/string "http")])
               (api/symbol 'many))

             (defncall 'sink-menu 'pipes/station (api/string "sink-menu"))
             (defncall 'sink-menu-items 'pipes/station (api/string "sink-menu-items"))
             (defncall 'sink-menu-events 'pipes/station (api/string "sink-menu-events"))
             (defncall 'sink-menu-state 'pipes/station (api/string "sink-menu-state"))
             ...
             (defncall 'source-menu-map 'pipes/splitter
               (api/fn-call (api/symbol '->)
                            [(api/vector [(api/key-fn :state)
             ...
             (defncall 'sink-menu-map 'pipes/splitter
               (api/fn-call (api/symbol '->)
                            [(api/vector [(api/key-fn :state)
                                          (api/fn-call (api/symbol '->) [(api/map {(api/keyword :count)
                                                                                   (api/fn-call (api/symbol 'count) [(api/key-fn :state)])
             ...
             (defncall 'reduce-menu-source 'pipes/splitter
               (api/fn-call (api/symbol '->)
                            [(api/vector [(api/key-fn :state) (api/key-fn :next)])
                             (api/fn-call (api/symbol 'into) [(api/map {}) (api/symbol '_)])])
             ...
             (defncall 'reduce-menu-sink 'pipes/splitter
               (api/fn-call (api/symbol '->)
                            [(api/vector [(api/key-fn :state) (api/key-fn :next)])
                             (api/fn-call (api/symbol 'into) [(api/map {}) (api/symbol '_)])])
               (api/map {(api/keyword :items) (api/vector [])
             ...
             (defncall 'state-dedupe 'pipes/splitter
               (api/fn-call (api/symbol '->)
              ...
              (defncall 'load-state 'pipes/station (api/string "load-state") ;; (api/keyword :oasis.spec/state)
                )
              (defncall 'loaded-state 'pipes/station (api/string "loaded-state") ;; (api/keyword :oasis.spec/state)
                )

              (defncall 'load-reduce 'pipes/splitter
                (api/fn-call (api/symbol '->)
                             [(api/vector [(api/key-fn :state) (api/key-fn :next)])
                              (api/fn-call (api/symbol 'into) [(api/map {}) (api/symbol '_)]) ])
             ...
             (defncall 'filter-load 'except
              ...
              (defncall 'layout-state 'pipes/station (api/string "layout-state") ;; (api/keyword :oasis.spec/state)
                )
             ...
             (defncall 'format-state '->
              ...
              (defncall 'lay-in 'pipes/station (api/string "lay-in"))
             ...
             (defncall 'handle-state 'pipes/splitter
               (api/fn-call (api/symbol '->)
             ...
             (defncall 'mode-data 'pipes/splitter
               (api/fn-call (api/symbol '->)
                            [
...
(def oasis-core-defs
  [(defncall 'oasis-core-init 'pipes/station (api/string "oasis-core-init"))
   (defncall 'oasis-kb 'pipes/station (api/string "oasis-kb"))
   (defncall 'oasis-hover-state 'pipes/station (api/string "oasis-hover-state"))
   (defncall 'oasis-hover-in 'pipes/station (api/string "oasis-hover-in"))
   (defncall 'oasis-scroll-state 'pipes/station (api/string "oasis-scroll-state"))
   (defncall 'oasis-drag-state 'pipes/station (api/string "oasis-drag-state"))
   (defncall 'oasis-core-events 'pipes/station (api/string "oasis-core-events"))
   (defncall 'oasis-core-out 'pipes/station (api/string "oasis-core-out"))
...
(def oasis-render-defs
  [
   (defncall 'oasis-render-in 'pipes/station (api/string "oasis-render-in"))
   (defncall 'oasis-render-init 'pipes/station (api/string "oasis-render-init"))
   (defncall 'oasis-render-mouse-in 'pipes/station (api/string "oasis-render-mouse-in"))
   (defncall 'oasis-render-kb-in 'pipes/station (api/string "oasis-render-kb-in"))
   (defncall 'oasis-render-kb-out 'pipes/station (api/string "oasis-render-kb-out"))
   (defncall 'oasis-render-drag-out 'pipes/station (api/string "oasis-render-drag-out"))
   (defncall 'oasis-render-hover-out 'pipes/station (api/string "oasis-render-hover-out"))
   (defncall 'oasis-render-out 'pipes/station (api/string "oasis-render-out"))
   (defncall 'scroll-state 'pipes/station (api/string "scroll-state"))
   ...
   (defncall 'view-raw 'pipes/station (api/string "view-raw") ;; (api/keyword :oasis.spec/mouse-state)
     )
   (defncall 'view-state 'pipes/station (api/string "view-state") ;; (api/keyword :oasis.spec/mouse-state)
     )
   (defncall 'view-deltas 'pipes/station (api/string "view-deltas") ;; (api/keyword :oasis.spec/mouse-state)
     )
   (defncall 'view-commands 'pipes/station (api/string "view-commands"))
   (defncall 'view-events 'pipes/station (api/string "view-events"))
   (defncall 'zoom-events 'pipes/station (api/string "zoom-events"))
   ...
   (defncall 'make-zoom 'pipes/splitter
     (api/fn-call (api/symbol '->)
   ...
   (defncall 'view-delta 'pipes/splitter
     (api/fn-call (api/symbol '->)
   ...
   (defncall 'center-view 'pipes/splitter
     (api/fn-call (api/symbol '->)
                  [(api/map {(api/keyword :x) (api/integer 150)
                             (api/keyword :y) (api/integer 50)})])
     (api/map {}))

   (defncall 'view-reduce 'pipes/splitter
     (api/fn-call (api/symbol '->)
   ...
   ;; Mouse handling
   (defncall 'drag-events 'pipes/station (api/string "drag-events"))
   ...
   (defncall 'mouse-reduce 'pipes/splitter
     (api/fn-call (api/symbol '->)
   ...
   (defncall 'mouse-state 'pipes/station (api/string "mouse-state") ;; (api/keyword :oasis.spec/mouse-state)
     )
   ...
   (defncall 'target-reduce 'pipes/splitter
     (api/fn-call (api/symbol '->) [
   ...
   (defncall 'target-events 'pipes/station (api/string "target-events") ;; (api/keyword :oasis.spec/mouse-state)
     )
   ...
   (defncall 'hover-events 'pipes/station (api/string "hover-events") ;; (api/keyword :oasis.spec/mouse-state)
     )
   (defncall 'hover-out 'pipes/station (api/string "hover-out") ;; (api/keyword :oasis.spec/mouse-state)
     )
   (defncall 'tag-hover '->
   ...
   (defncall 'state-reduce 'pipes/splitter
     (api/fn-call (api/symbol '->)
                  [(api/vector [(api/key-fn :state) (api/key-fn :next)])
                   (api/fn-call (api/symbol 'into) [(api/map {}) (api/symbol '_)]) ])
     (api/map {}))
   ...
   (defncall 'condensed-state 'pipes/station (api/string "condensed-state") ;; (api/keyword :oasis.spec/state)
     )
   ...
   (defncall 'svg-elements-reduce 'pipes/splitter
     (api/fn-call (api/symbol '->)
                  [(api/vector [(api/key-fn :state) (api/key-fn :next)])
                   (api/fn-call (api/symbol 'into) [(api/map {}) (api/symbol '_)])])
   ...
   (defncall 'svg-reduced 'pipes/station (api/string "svg-reduced")  ;; (api/keyword :oasis.spec/render)
     )
   ...
   (defncall 'svg-render 'pipes/station (api/string "svg-render"))
   (defncall 'render-svg '->
...
(def oasis-render-net
  [
   ...
   ;; (pipe 'oasis-render-in 'log-hov)
   (pipe 'state-reduce 'condensed-state)
   ;; (pipe 'condensed-state 'log-view)
...
(def oasis-ui-defs
  [
   ...
   (defncall 'oasis-ui-kb-out 'pipes/station (api/string "oasis-ui-kb-out"))
   (defncall 'oasis-ev 'pipes/station (api/string "oasis-ev"))
   (defncall 'oasis-ui-mouse-out 'pipes/station (api/string "oasis-ui-mouse-out"))
   ;; (defncall 'oasis-ui-foo 'pipes/station (api/string "oasis-ui-foo"))
   (defncall 'oasis-ui-in 'pipes/station (api/string "oasis-ui-in"))
   (defncall 'render 'pipes/station (api/string "render") ;; (api/keyword :oasis.spec/render)
     )
   (defncall 'reducer 'pipes/station (api/string "reducer") ;; (api/keyword :oasis.spec/gui)
     )
   (defncall 'elements-reduce 'pipes/splitter
     (api/fn-call (api/symbol 'into) [(api/key-fn :state) (api/key-fn :next)])
     (api/map {}))
   ...
   (defncall 'log-kb2 'pipes/log (api/string "kb2: "))
...
(def oasis-ui-net
  [
   ...
   (pipe 'oasis-ui-mod-events 'oasis-ev)

   (pipe 'oasis-ui-mod-mouse 'oasis-ui-mouse-out)
   (pipe 'oasis-ui-mod-kb 'oasis-ui-kb-out)

   ;; (pipe 'oasis-ui-mod-events 'log-render2)
...
(def oasis-module-defs
  [
   ...
   (defncall 'oasis-init 'pipes/station (api/string "oasis-init"))
   (api/defmodule 'oasis (api/map {(api/keyword :depends) (api/map {(api/keyword :oasis-core) (api/symbol 'oasis-core)
                                   ...
                                   (api/keyword :sources) (api/map {(api/keyword :module-core-out) (api/symbol 'core-state)
                                                                    ...
                                                                    (api/keyword :module-core-events-in) (api/symbol 'core-events-in)
